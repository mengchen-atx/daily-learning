...
Installed Pixel Agents in VS Code by cloning the repository locally. Since the extension's required version was incompatible, I manually adjusted the engines field in package.json to match my current VS Code version and successfully ran it from source.
